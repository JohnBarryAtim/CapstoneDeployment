        ...
        <template>
          <div>
            <nuxt-link to="/beneficiary">
              ...
              <v-btn to="/beneficiary" color="blue">Return</v-btn>
            </nuxt-link>
          </div>
        </template>
      </v-col>
  ...
  computed: {
    filteredPersons() {
      return this.Persons.filter(person => {
        return person.Email.toLowerCase().includes(this.search.toLowerCase())&&person.Status === "Deactive"//ILisan ranig deactivate
